...
public class ReflectorProduct {
	private ReflectorProductProduct reflectorProductProduct = new ReflectorProductProduct();
	...
	public ReflectorProduct(Class<?> clazz) {
		type = clazz;
	}
	...
	*/
	...
	public void addGetField(Field field) {
		if (reflectorProductProduct.isValidPropertyName(field.getName())) {
	...
	public Method pickBetterSetter(Method setter1, Method setter2, String property) {
		...
		MethodInvoker invoker = invoker(setter1, setter2, property);
	...
	private MethodInvoker invoker(Method setter1, Method setter2, String property) {
		Class<?> paramType1 = setter1.getParameterTypes()[0];
		Class<?> paramType2 = setter2.getParameterTypes()[0];
	...
	*/
	...
	private Method match(Map.Entry<String, List<Method>> entry) {
		String propName = entry.getKey();
	...
	public void addGetMethods(Method[] methods) {
		reflectorProductProduct.addGetMethods(methods, this);
	}

	public void resolveGetterConflicts(Map<String, List<Method>> conflictingGetters) {
		reflectorProductProduct.resolveGetterConflicts(conflictingGetters, this);
	}

	public void addMethodConflict(Map<String, List<Method>> conflictingMethods, String name, Method method) {
		reflectorProductProduct.addMethodConflict(conflictingMethods, name, method);
	}

	public boolean isValidPropertyName(String name) {
		return reflectorProductProduct.isValidPropertyName(name);
	}

	public void addSetMethods(Method[] methods) {
		reflectorProductProduct.addSetMethods(methods, this);
	}
}